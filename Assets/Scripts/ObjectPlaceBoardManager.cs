...
public class ObjectPlaceBoardManager : Solver
{
    [SerializeField]
    ...
    {
        Debug.Log("STARTING OBJECT PLACE MANAGER");
        base.Start();
    ...
    public void BeginPlacement(GameObject obj)
    {
        controlledGameObject = obj;
        ...
        if (!isPlacing)
        {
            gameObject.GetComponent<MaterialSwitcher>().ChangeMaterials(materialWhilePlacing);
            ...
            controlledGameObject.layer = ignoreRaycastLayer;
    ...
    void EndPlacement()
    {
        ...
        using (StopPlacementPerfMarker.Auto())
        {
            ...
            if (isPlacing)
            {
                gameObject.GetComponent<MaterialSwitcher>().RestoreOriginalMaterials();
        ...
        using (SolverUpdatePerfMarker.Auto())
        {
            ...
            if (InteractorSelectPerformedThisFrame())
            {
                ...
                else
                {
                    ...
                    BeginPlacement(controlledGameObject);
                }
            }
        }
    }
